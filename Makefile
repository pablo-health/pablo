...
test:
	...
	cd backend && DATABASE_URL=postgresql://pablo:pablo_dev@localhost:5432/pablo poetry run pytest tests/ --cov=app --cov-report=term-missing --cov-report=html --cov-fail-under=67
