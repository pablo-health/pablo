...
"""Remittance Advice Remark Codes (RARC), as published by X12.

Source: X12 External Code Lists, "Remittance Advice Remark Codes",
https://x12.org/codes/remittance-advice-remark-codes
List version: 7/1/2026 (the "updated" date shown on the page).
Retrieved: 2026-09-06.

Every code X12 publishes is here, including deactivated ones, for the same
reason :mod:`app.claims.codes.carc` keeps them: old remittances still cite
them. :data:`DEACTIVATED_RARC` names the retired ones.
...
RARC: dict[str, str] = {
    ...
    "M6": (
        "Alert: You must furnish and service this item for any period of medical need for the "
        "remainder of the reasonable useful lifetime of the equipment."
    ),
    "M7": (
        "No rental payments after the item is purchased, returned or after the total of issued "
        "rental payments equals the purchase price."
    ),
    "M8": (
        "We do not accept blood gas tests results when the test was conducted by a medical supplier"
        " or taken while the patient is on oxygen."
    ),
    "M9": (
    ...
    "M11": (
        "DME, orthotics and prosthetics must be billed to the DME carrier who services the "
        "patient's zip code."
    ),
    "M12": (
    ...
    "M15": (
        "Separately billed services/tests have been bundled as they are considered components of "
        "the same procedure. Separate payment is not allowed."
    ),
    "M16": (
    ...
    "M17": (
        "Alert: Payment approved as you did not know, and could not reasonably have been expected "
    ...
    "M25": (
        ...
        "service, or if you notified the patient in writing in advance that we would not pay for "
        "this level of service and he/she agreed in writing to pay, ask us to review your claim "
        "within 120 days of the date of this notice. If you do not request an appeal, we will, upon"
        " application from the patient, reimburse him/her for the amount you have collected from "
        "him/her in excess of any deductible and coinsurance amounts. We will recover the "
        "reimbursement from you as an overpayment."
    ),
    "M26": (
        "The information furnished does not substantiate the need for this level of service. If you"
        " have collected any amount from the patient for this level of service/any amount that "
        "exceeds the limiting charge for the less extensive service, the law requires you to refund"
        " that amount to the patient within 30 days of receiving this notice. The requirements for "
        "refund are in 1824(I) of the Social Security Act and 42CFR411.408. The section specifies "
        "that physicians who knowingly and willfully fail to make appropriate refunds may be "
        "subject to civil monetary penalties and/or exclusion from the program. If you have any "
    ...
    "M27": (
        ...
        "under the limitation of liability provision of the law. The provider is ultimately liable "
        "for the patient's waived charges, including any charges for coinsurance, since the items "
        "or services were not reasonable and necessary or constituted custodial care, and you knew "
        "or could reasonably have been expected to know, that they were not covered. You may appeal"
        " this determination. You may ask for an appeal regarding both the coverage determination "
        "and the issue of whether you exercised due care. The appeal request must be filed within "
        "120 days of the date you receive this notice. You must make the request through this "
        "office."
    ),
    "M28": (
        "This does not qualify for payment under Part B when Part A coverage is exhausted or not "
        "otherwise available."
    ),
    ...
    "M32": (
        "Alert: This is a conditional payment made pending a decision on this service by the "
        "patient's primary payer. This payment may be subject to refund upon your receipt of any "
    ...
    "M38": (
        "Alert: The patient is liable for the charges for this service as they were informed in "
        "writing before the service was furnished that we would not pay for it and the patient "
        "agreed to be responsible for the charges."
    ),
    "M39": (
    ...
    "M43": (
        "Payment for this service previously issued to you or another provider by another "
    ...
    "M47": (
        "Missing/incomplete/invalid Payer Claim Control Number. Other terms exist for this element "
        "including, but not limited to, Internal Control Number (ICN), Claim Control Number (CCN), "
        "Document Control Number (DCN)."
    ),
    "M48": (
        "Payment for services furnished to hospital inpatients (other than professional services of"
        " physicians) can only be made to the hospital. You must request payment from the hospital "
    ...
    "M65": (
        "One interpreting physician charge can be submitted per claim when a purchased diagnostic "
        "test is indicated. Please submit a separate claim for each interpreting physician."
    ),
    "M66": (
        "Our records indicate that you billed diagnostic tests subject to price limitations and the"
        " procedure code submitted includes a professional component. Only the technical component "
        "is subject to price limitations. Please submit the technical and professional components "
        "of this service as separate line items."
    ),
    "M67": "Missing/incomplete/invalid other procedure code(s).",
    "M68": (
        "Missing/incomplete/invalid attending, ordering, rendering, supervising or referring "
        "physician identification."
    ),
    "M69": (
        "Paid at the regular rate as you did not submit documentation to justify the modified "
        "procedure code."
    ),
    "M70": (
        "Alert: The NDC code submitted for this service was translated to a HCPCS code for "
        "processing, but please continue to submit the NDC on future claims for this item."
    ),
    "M71": "Total payment reduced due to overlap of tests billed.",
    "M72": "Did not enter full 8-digit date (MM/DD/CCYY).",
    "M73": (
        "The HPSA/Physician Scarcity bonus can only be paid on the professional component of this "
        "service. Rebill as separate professional and technical components."
    ),
    ...
    "M80": (
        "Not covered when performed during the same session/date as a previously processed service "
        "for the patient."
    ),
    ...
    "M93": (
        "Information supplied supports a break in therapy. A new capped rental period began with "
    ...
    "M96": (
        ...
        "inpatient facility. You must contact the inpatient facility for technical component "
        "reimbursement. If not already billed, you should bill us for the professional component "
        "only."
    ),
    "M97": (
        "Not paid to practitioner when provided to patient in this place of service. Payment "
    ...
    "M101": (
        ...
        "this service if billed without a G1-G5 modifier."
    ),
    ...
    "M103": (
        ...
        " for this patient does not support the need for this item as billed. We have approved "
    ...
    "M104": (
        ...
        "with delivery of the equipment. This is the maximum approved under the fee schedule for "
    ...
    "M106": (
        "Information supplied does not support a break in therapy. A new capped rental period will "
        "not begin. This is the maximum approved under the fee schedule for this item or service."
    ),
    "M107": "Payment reduced as 90-day rolling average hematocrit for ESRD patient exceeded 36.5%.",
    "M108": (
        "Missing/incomplete/invalid provider identifier for the provider who interpreted the "
        "diagnostic test."
    ),
    "M109": (
        "We have provided you with a bundled payment for a teleconsultation. You must send 25 "
        "percent of the teleconsultation payment to the referring practitioner."
    ),
    "M110": (
    ...
    "M114": (
        ...
        "Competitive Bidding Program or a Demonstration Project. For more information regarding "
        "these projects, contact your local contractor."
    ),
    "M115": (
        "This item is denied when provided to this patient by a non-contract or non-demonstration "
        "supplier."
    ),
    "M116": (
    ...
    "M120": (
        "Missing/incomplete/invalid provider identifier for the substituting physician who "
    ...
    "M130": (
        "Missing invoice or statement certifying the actual cost of the lens, less discounts, "
    ...
    "M133": (
        "Claim did not identify who performed the purchased diagnostic test or the amount you were "
    ...
    "MA03": (
        "If you do not agree with the approved amounts and $100 or more is in dispute (less "
        "deductible and coinsurance), you may ask for a hearing within six months of the date of "
    ...
    "MA04": (
        "Secondary payment cannot be considered without the identity of or payment information from"
        " the primary payer. The information was either not reported or was illegible."
    ),
    ...
    "MA08": (
        "Alert: Claim information was not forwarded because the supplemental coverage is not with a"
        " Medigap plan, or you do not participate in Medicare."
    ),
    "MA09": (
        "Alert: Claim submitted as unassigned but processed as assigned in accordance with our "
    ...
    "MA11": (
        ...
        "insurance, Workers' Compensation, Department of Veterans Affairs, or a group health plan "
        "for employees and dependents also covers this claim, a refund may be due us. Please "
        "contact us if the patient is covered by any of these sources."
    ),
    "MA12": (
        "You have not established that you have the right under the law to bill for services "
    ...
    "MA14": (
        "Alert: The patient is a member of an employer-sponsored prepaid health plan. Services from"
        " outside that health plan are not covered. However, as you were not previously notified of"
        " this, we are paying this time. In the future, we will not pay you for non-plan services."
    ),
    "MA15": (
    ...
    "MA17": (
        "We are the primary payer and have paid at the primary rate. You must contact the patient's"
        " other insurer to refund any excess it may have paid due to its erroneous primary payment."
    ),
    "MA18": (
        "Alert: The claim information is also being forwarded to the patient's supplemental "
        "insurer. Send any questions regarding supplemental benefits to them."
    ),
    "MA19": (
        "Alert: Information was not sent to the Medigap insurer due to incorrect/invalid "
        "information you submitted concerning that insurer. Please verify your information and "
    ...
    "MA24": (
        "Christian Science Sanitarium/ Skilled Nursing Facility (SNF) bill in the same benefit "
        "period."
    ),
    "MA25": (
    ...
    "MA28": (
        ...
        "for information only and does not make the physician or supplier a party to the "
    ...
    "MA49": (
        "Missing/incomplete/invalid six-digit provider identifier for home health agency or hospice"
        " for physician(s) performing care plan oversight services."
    ),
    "MA50": (
        "Missing/incomplete/invalid Investigational Device Exemption number or Clinical Trial "
        "number."
    ),
    "MA51": (
    ...
    "MA59": (
        ...
        "within 30 days for the difference between his/her payment and the total amount shown as "
    ...
    "MA68": (
        "Alert: We did not crossover this claim because the secondary insurance information on the "
        "claim was incomplete. Please supply complete information or use the PLANID of the insurer "
    ...
    "MA73": (
        "Informational remittance associated with a Medicare demonstration. No payment issued under"
        " fee-for-service Medicare as patient has elected managed care."
    ),
    "MA74": (
        "Alert: This payment replaces an earlier payment for this claim that was either lost, "
        "damaged or returned."
    ),
    ...
    "MA77": (
        ...
        "the difference between the patient's payment less the total of our and other payer "
        "payments and the amount shown as patient responsibility on this notice."
    ),
    "MA78": (
        "The patient overpaid you. You must issue the patient a refund within 30 days for the "
        "difference between our allowed amount total and the amount paid by the patient."
    ),
    "MA79": "Billed in excess of interim rate.",
    "MA80": (
        "Informational notice. No payment issued for this claim with this notice. Payment issued to"
        " the hospital by its intermediary for all services for this encounter under a "
    ...
    "MA85": (
        ...
        "not complete or enter accurately the insurance plan/group/program name or identification "
        "number. Enter the PlanID when effective."
    ),
    "MA86": (
    ...
    "MA94": (
        "Did not enter the statement 'Attending physician not hospice employee' on the claim form "
        "to certify that the rendering physician is not an employee of the hospice."
    ),
    "MA95": (
        "A not otherwise classified or unlisted procedure code(s) was billed but a narrative "
        "description of the procedure was not entered on the claim. Refer to item 19 on the "
        "HCFA-1500."
    ),
    "MA96": (
        "Claim rejected. Coded as a Medicare Managed Care Demonstration but patient is not enrolled"
        " in a Medicare managed care plan."
    ),
    "MA97": (
        "Missing/incomplete/invalid Medicare Managed Care Demonstration contract number or clinical"
        " trial registry number."
    ),
    "MA98": (
        "Claim Rejected. Does not contain the correct Medicare Managed Care Demonstration contract "
        "number for this beneficiary."
    ),
    ...
    "MA104": (
        "Missing/incomplete/invalid date the patient was last seen or the provider identifier of "
    ...
    "MA110": (
        "Missing/incomplete/invalid information on whether the diagnostic test(s) were performed by"
        " an outside entity or if no purchased tests are included on the claim."
    ),
    "MA111": (
    ...
    "MA113": (
        ...
        "Revenue Service. Your claims cannot be processed without your correct TIN, and you may not"
        " bill the patient pending correction of your TIN. There are no appeal rights for "
        "unprocessable claims, but you may resubmit this claim after you have notified this office "
        "of your correct TIN."
    ),
    "MA114": "Missing/incomplete/invalid information on where the services were furnished.",
    "MA115": (
        "Missing/incomplete/invalid physical location (name and address, or PIN) where the "
    ...
    "MA118": (
        "Alert: No Medicare payment issued for this claim for services or supplies furnished to a "
        "Medicare-eligible veteran through a facility of the Department of Veterans Affairs. "
        "Coinsurance and/or deductible are applicable."
    ),
    ...
    "MA131": (
        "Physician already paid for services in conjunction with this demonstration claim. You must"
        " have the physician withdraw that claim and refund the payment before we can process your "
        "claim."
    ),
    ...
    "N1": (
        ...
        "receipt of this notice by following the instructions included in your contract, plan "
        "benefit documents or jurisdiction statutes. Refer to the URL provided in the ERA for the "
        "payer website to access the appeals process guidelines."
    ),
    "N2": (
        "This allowance has been made in accordance with the most appropriate course of treatment "
    ...
    "N6": (
        ...
        "Medicare would have allowed if the patient were enrolled in Medicare Part A and/or "
        "Medicare Part B."
    ),
    "N7": (
        "Alert: Processing of this claim/service has included consideration under Major Medical "
        "provisions."
    ),
    "N8": (
        "Crossover claim denied by previous payer and complete claim data not forwarded. Resubmit "
        "this claim to this payer to provide adequate data for adjudication."
    ),
    "N9": "Adjustment represents the estimated amount a previous payer may pay.",
    "N10": (
        "Adjustment based on the findings of a review organization/professional consult/manual "
        "adjudication/medical advisor/dental advisor/peer review."
    ),
    "N11": "Denial reversed because of medical review.",
    "N12": (
        "Policy provides coverage supplemental to Medicare. As the member does not appear to be "
        "enrolled in the applicable part of Medicare, the member is responsible for payment of the "
    ...
    "N14": (
        "Payment based on a contractual amount or agreement, fee schedule, or maximum allowable "
        "amount."
    ),
    ...
    "N22": (
        "Alert: This procedure code was added/changed because it more accurately describes the "
        "services rendered."
    ),
    "N23": (
    ...
    "N59": (
        "Alert: Please refer to your provider manual for additional program and provider "
        "information."
    ),
    ...
    "N67": (
        ...
        "facility notifies you the patient was excluded from this demonstration; or if you "
        ...
        "involved in the demonstration on the same date the patient was discharged from or admitted"
        " to a demonstration facility, you must report the provider ID number for the "
        "non-demonstration facility on the new claim."
    ),
    "N68": (
        "Prior payment being cancelled as we were subsequently notified this patient was covered by"
        " a demonstration project in this site of service. Professional services were included in "
        "the payment made to the facility. You must contact the facility for your payment. Prior "
        "payment made to you by the patient or another insurer for this claim must be refunded to "
        "the payer within 30 days."
    ),
    ...
    "N71": (
        ...
        " ambulance service was processed as an assigned claim. You are required by law to accept "
        "assignment for these types of claims."
    ),
    "N72": (
        "PPS (Prospective Payment System) code changed by medical reviewers. Not supported by "
        "clinical records."
    ),
    "N73": (
    ...
    "N74": (
        "Resubmit with multiple claims, each claim covering services provided in only one calendar "
        "month."
    ),
    ...
    "N83": (
        "No appeal rights. Adjudicative decision based on the provisions of a demonstration "
        "project."
    ),
    "N84": "Alert: Further installment payments are forthcoming.",
    "N85": "Alert: This is the final installment payment.",
    "N86": (
        "A failed trial of pelvic muscle exercise training is required in order for biofeedback "
        "training for the treatment of urinary incontinence to be covered."
    ),
    "N87": "Home use of biofeedback therapy is not covered.",
    "N88": (
        "Alert: This payment is being made conditionally. An HHA episode of care notice has been "
        ...
        " included in the HHA's payment. This payment will need to be recouped from you if we "
        "establish that the patient is concurrently receiving treatment under a HHA episode of "
        "care."
    ),
    "N89": (
        "Alert: Payment information for this claim has been forwarded to more than one other payer,"
    ...
    "N93": (
        "A separate claim must be submitted for each place of service. Services furnished at "
    ...
    "N96": (
        "Patient must be refractory to conventional therapy (documented behavioral, pharmacologic "
        "and/or surgical corrective therapy) and be an appropriate surgical candidate such that "
    ...
    "N98": (
        ...
        "demonstrate a 50 percent or greater improvement through test stimulation. Improvement is "
    ...
    "N101": (
        "Additional information is needed in order to process this claim. Please resubmit the claim"
        " with the identification number of the provider where this service took place. The "
        "Medicare number of the site of service provider should be preceded with the letters 'HSP' "
        "and entered into item #32 on the claim form. You may bill only one site of service "
        "provider number per claim."
    ),
    "N102": (
        "This claim has been denied without reviewing the medical/dental record because the "
        "requested records were not received or were not received timely."
    ),
    "N103": (
        "Records indicate this patient was a prisoner or in custody of a Federal, State, or local "
        "authority when the service was rendered. This payer does not cover items and services "
        "furnished to an individual while he or she is in custody under a penal statute or rule, "
        "unless under State or local law, the individual is personally liable for the cost of his "
        "or her health care while in custody and the State or local government pursues the "
        "collection of such debt in the same way and with the same vigor as the collection of its "
        "other debts. The provider can collect from the Federal/State/ Local Authority as "
        "appropriate."
    ),
    "N104": (
    ...
    "N105": (
        "This is a misdirected claim/service for an RRB beneficiary. Submit paper claims to the RRB"
        " carrier: Palmetto GBA, P.O. Box 10066, Augusta, GA 30999. Call 888-355-9165 for RRB EDI "
    ...
    "N106": (
        ...
        "excluded services) can only be made to the SNF. You must request payment from the SNF "
        "rather than the patient for this service."
    ),
    "N107": (
        "Services furnished to Skilled Nursing Facility (SNF) inpatients must be billed on the "
    ...
    "N111": (
        "No appeal right except duplicate claim/service issue. This service was included in a claim"
        " that has been previously billed and adjudicated."
    ),
    ...
    "N114": (
        "During the transition to the Ambulance Fee Schedule, payment is based on the lesser of a "
        "blended amount calculated using a percentage of the reasonable charge/cost and fee "
    ...
    "N115": (
        "This decision was based on a Local Coverage Determination (LCD). An LCD provides a guide "
        "to assist in determining whether a particular item or service is covered. A copy of this "
    ...
    "N116": (
        "Alert: This payment is being made conditionally because the service was provided in the "
        ...
        "agency's (HHA's) payment. This payment will need to be recouped from you if we establish "
        "that the patient is concurrently receiving treatment under an HHA episode of care."
    ),
    ...
    "N119": (
        ...
        " consecutive days in any inpatient or Skilled /nursing Facility (SNF) within those 28 "
        "days."
    ),
    "N120": (
    ...
    "N123": (
        "Alert: This is a split service and represents a portion of the units from the originally "
        "submitted service."
    ),
    "N124": (
        "Payment has been denied for the/made only for a less extensive service/item because the "
        "information furnished does not substantiate the need for the (more extensive) "
        "service/item. The patient is liable for the charges for this service/item as you informed "
        "the patient in writing before the service/item was furnished that we would not pay for it,"
        " and the patient agreed to pay."
    ),
    "N125": (
        "Payment has been (denied for the/made only for a less extensive) service/item because the "
        "information furnished does not substantiate the need for the (more extensive) "
        "service/item. If you have collected any amount from the patient, you must refund that "
        "amount to the patient within 30 days of receiving this notice. The requirements for a "
        "refund are in §1834(a)(18) of the Social Security Act (and in §§1834(j)(4) and 1879(h) by "
        "cross-reference to §1834(a)(18)). Section 1834(a)(18)(B) specifies that suppliers which "
        "knowingly and willfully fail to make appropriate refunds may be subject to civil money "
        "penalties and/or exclusion from the Medicare program. If you have any questions about this"
    ...
    "N133": (
        "Alert: Services for predetermination and services requesting payment are being processed "
        "separately."
    ),
    "N134": (
    ...
    "N136": (
        "Alert: To obtain information on the process to file an appeal in Arizona, call the "
        "Department's Consumer Assistance Office at (602) 912-8444 or (800) 325-2548."
    ),
    "N137": (
        ...
        "urgent condition for which care has not been rendered. The address may be obtained from "
    ...
    "N138": (
        ...
        "information relative to the case, you may submit radiographs to the Dental Advisor Unit at"
        " the subscriber's dental insurance carrier for a second Independent Dental Advisor Review."
    ),
    "N139": (
        "Alert: Under 32 CFR 199.13, a non-participating provider is not an appropriate appealing "
        "party. Therefore, if you disagree with the Dental Advisor's opinion, you may appeal the "
        "determination if appointed in writing, by the beneficiary, to act as his/her "
        "representative. Should you be appointed as a representative, submit a copy of this letter,"
        " a signed statement explaining the matter in which you disagree, and any radiographs and "
        "relevant information to the subscriber's Dental insurance carrier within 90 days from the "
        "date of this letter."
    ),
    "N140": (
        "Alert: You have not been designated as an authorized OCONUS provider therefore are not "
        ...
        "opinion, you may appeal by submitting a copy of this letter, a signed statement explaining"
    ...
    "N141": (
        "The patient was not residing in a long-term care facility during all or part of the "
    ...
    "N151": (
        "Telephone contact services will not be paid until the face-to-face contact requirement has"
        " been met."
    ),
    ...
    "N162": (
        ...
        "your Laboratory Certification. Your failure to correct the laboratory certification "
    ...
    "N172": (
        "The patient is not liable for the denied/adjusted charge(s) for receiving any updated "
        "service/item."
    ),
    ...
    "N176": (
        "Services provided aboard a ship are covered only when the ship is of United States "
    ...
    "N177": (
        "Alert: We did not send this claim to patient's other insurer. They have indicated no "
    ...
    "N187": (
        "Alert: You may request a review in writing within the required time limits following "
        "receipt of this notice by following the instructions included in your contract or plan "
        "benefit documents."
    ),
    ...
    "N201": (
        "A mental health facility is responsible for payment of outside providers who furnish these"
    ...
    "N216": (
        "We do not offer coverage for this type of service or the patient is not enrolled in this "
    ...
    "N230": (
        "Incomplete/invalid indication of whether the patient owns the equipment that requires the "
        "part or supply."
    ),
    "N231": (
        "Incomplete/invalid invoice or statement certifying the actual cost of the lens, less "
    ...
    "N347": (
        "Your claim for a referred or purchased service cannot be paid because payment has already "
        "been made for this same service to another provider by a payment contractor representing "
        "the payer."
    ),
    "N348": (
        "You chose that this service/supply/drug would be rendered/supplied and billed by a "
    ...
    "N353": (
        "Alert: Benefits have been estimated, when the actual services have been rendered, "
    ...
    "N355": (
        ...
        " know, and could not have reasonably been expected to know, that we would not pay for this"
        " service; or - If you notified the patient in writing before providing the service that "
        "you believed that we were likely to deny the service, and the patient signed a statement "
        "agreeing to pay for the service. If you come within either exception, or if you believe "
        "the carrier was wrong in its determination that we do not pay for this service, you should"
        " request appeal of this determination within 30 days of the date of this notice. Your "
        "request for review should include any additional information necessary to support your "
        "position. If you request an appeal within 30 days of receiving this notice, you may delay "
        "refunding the amount to the patient until you receive the results of the review. If the "
        "review decision is favorable to you, you do not need to make any refund. If, however, the "
        "review is unfavorable, the law specifies that you must make the refund within 15 days of "
        "receiving the unfavorable review decision. The law also permits you to request an appeal "
        "at any time within 120 days of the date you receive this notice. However, an appeal "
        "request that is received more than 30 days after the date of this notice, does not permit "
        "you to delay making the refund. Regardless of when a review is requested, the patient will"
        ...
        "that he/she may be entitled to a refund of any amounts paid, if you should have known that"
        " we would not pay and did not tell him/her. It also instructs the patient to contact our "
    ...
    "N360": (
        ...
        "pre-determination. Submit payment information from the primary payer with the secondary "
        "claim."
    ),
    ...
    "N366": (
        ...
        "previously requested is submitted within one year after the date of this denial notice."
    ),
    "N367": (
        "Alert: The claim information has been forwarded to a Consumer Spending Account processor "
        "for review; for example, flexible spending account or health savings account."
    ),
    "N368": "You must appeal the determination of the previously adjudicated claim.",
    "N369": (
        "Alert: Although this claim has been processed, it is deficient according to state "
    ...
    "N373": (
        "It has been determined that another payer paid the services as primary when they were not "
        "the primary payer. Therefore, we are refunding to the payer that paid as primary on your "
        "behalf."
    ),
    "N374": (
        "Primary Medicare Part A insurance has been exhausted and a Part B Remittance Advice is "
        "required."
    ),
    "N375": (
    ...
    "N381": (
        "Alert: Consult our contractual agreement for restrictions/billing/payment information "
    ...
    "N386": (
        "This decision was based on a National Coverage Determination (NCD). An NCD provides a "
        "coverage determination as to whether a particular item or service is covered. Visit "
        "CMS.gov and search for Medicare Coverage Database to find a copy of the policy."
    ),
    "N387": (
        "Alert: Submit this claim to the patient's other insurer for potential payment of "
        "supplemental benefits. We did not forward the claim information."
    ),
    ...
    "N409": (
        "This service is related to an accidental injury and is not covered unless provided within "
        "a specific time frame from the date of the accident."
    ),
    ...
    "N419": (
        "Claim payment was the result of a payer's retroactive adjustment due to a retroactive rate"
        " change."
    ),
    "N420": (
        "Claim payment was the result of a payer's retroactive adjustment due to a Coordination of "
        "Benefits or Third Party Liability Recovery."
    ),
    "N421": (
        "Claim payment was the result of a payer's retroactive adjustment due to a review "
        "organization decision."
    ),
    "N422": (
        "Claim payment was the result of a payer's retroactive adjustment due to a payer's contract"
        " incentive program."
    ),
    "N423": (
    ...
    "N436": (
        "The injury claim has not been accepted and a mandatory medical reimbursement has been "
        "made."
    ),
    ...
    "N444": (
        "Alert: This facility has not filed the Election for High Cost Outlier form with the "
    ...
    "N480": (
        "Incomplete/invalid Explanation of Benefits (Coordination of Benefits or Medicare Secondary"
        " Payer)."
    ),
    "N481": "Missing Models.",
    ...
    "N492": (
        "Alert: A network provider may bill the member for this service if the member requested the"
        " service and agreed in writing, prior to receiving the service, to be financially "
        "responsible for the billed charge."
    ),
    ...
    "N505": (
        "Alert: This response includes only services that could be estimated in real-time. No "
        "estimate will be provided for the services that could not be estimated in real-time."
    ),
    "N506": (
        "Alert: This is an estimate of the member's liability based on the information available at"
        " the time the estimate was processed. Actual coverage and member liability amounts will be"
        " determined when the claim is processed. This is not a pre-authorization or a guarantee of"
        " payment."
    ),
    "N507": "Plan distance requirements have not been met.",
    "N508": (
        "Alert: This real-time claim adjudication response represents the member responsibility to "
        "the provider for services reported. The member will receive an Explanation of Benefits "
        "electronically or in the mail. Contact the insurer if there are any questions."
    ),
    "N509": (
        "Alert: A current inquiry shows the member's Consumer Spending Account contains sufficient "
        "funds to cover the member liability for this claim/service. Actual payment from the "
        "Consumer Spending Account will depend on the availability of funds and determination of "
        "eligible services at the time of payment processing."
    ),
    "N510": (
        "Alert: A current inquiry shows the member's Consumer Spending Account does not contain "
        "sufficient funds to cover the member's liability for this claim/service. Actual payment "
        "from the Consumer Spending Account will depend on the availability of funds and "
    ...
    "N512": (
        "Alert: This is the initial remit of a non-NCPDP claim originally submitted real-time "
        "without change to the adjudication."
    ),
    "N513": (
        "Alert: This is the initial remit of a non-NCPDP claim originally submitted real-time with "
        "a change to the adjudication."
    ),
    "N514": (
        "Consult plan benefit documents/guidelines for information about restrictions for this "
        "service."
    ...
    "N515": (
        "Alert: Submit this claim to the patient's other insurer for potential payment of "
        "supplemental benefits. We did not forward the claim information. (use N387 instead)"
    ),
    ...
    "N521": (
        "Mismatch between the submitted provider information and the provider information stored in"
        " our system."
    ),
    ...
    "N545": (
        "Payment reduced based on status as an unsuccessful eprescriber per the Electronic "
        "Prescribing (eRx) Incentive Program."
    ),
    "N546": (
        "Payment represents a previous reduction based on the Electronic Prescribing (eRx) "
        "Incentive Program."
    ),
    ...
    "N550": (
        "Alert: You have not responded to requests to revalidate your provider/supplier enrollment "
        "information. Your failure to revalidate your enrollment information will result in a "
    ...
    "N560": (
        "The pilot program requires an interim or final claim within 60 days of the Notice of "
        "Admission. A claim was not received."
    ),
    "N561": (
        "The bundled claim originally submitted for this episode of care includes related "
        "readmissions. You may resubmit the original claim to receive a corrected payment based on "
        "this readmission."
    ),
    "N562": (
    ...
    "N563": (
        "Alert: Missing required provider/supplier issuance of advance patient notice of "
        "non-coverage. The patient is not liable for payment for this service."
    ),
    "N564": (
        "Patient did not meet the inclusion criteria for the demonstration project or pilot "
        "program."
    ),
    "N565": (
    ...
    "N566": (
        ...
        "procedure code must include an applicable non-payable code and appropriate modifiers for "
        "the claim to be processed."
    ),
    "N567": "Not covered when considered preventative.",
    "N568": (
        "Alert: Initial payment based on the Notice of Admission (NOA) under the Bundled Payment "
        "Model IV initiative."
    ),
    ...
    "N572": (
        "This procedure is not payable unless appropriate non-payable reporting codes and "
        "associated modifiers are submitted."
    ),
    "N573": (
        "Alert: You have been overpaid and must refund the overpayment. The refund will be "
        "requested separately by another payer/contractor."
    ),
    "N574": (
        "Our records indicate the ordering/referring provider is of a type/specialty that cannot "
        "order or refer. Please verify that the claim ordering/referring provider information is "
        "accurate or contact the ordering/referring provider."
    ),
    "N575": (
        "Mismatch between the submitted ordering/referring provider name and the ordering/referring"
        " provider name stored in our records."
    ),
    ...
    "N583": (
        "Patient was not an occupant of our insured vehicle and therefore, is not an eligible "
        "injured person."
    ),
    ...
    "N589": (
        "Coverage is excluded to any person injured as a result of operating a motor vehicle while "
        "in an intoxicated condition or while the ability to operate such a vehicle is impaired by "
        "the use of a drug."
    ),
    "N590": (
        "Missing independent medical exam detailing the cause of injuries sustained and medical "
        "necessity of services rendered."
    ),
    "N591": "Payment based on an Independent Medical Examination (IME) or Utilization Review (UR).",
    "N592": (
        "Adjusted because this is not the initial prescription or exceeds the amount allowed for "
        "the initial prescription."
    ),
    "N593": "Not covered based on failure to attend a scheduled Independent Medical Exam (IME).",
    "N594": (
        "Records reflect the injured party did not complete an Application for Benefits for this "
        "loss."
    ),
    "N595": (
        "Records reflect the injured party did not complete an Assignment of Benefits for this "
        "loss."
    ),
    "N596": (
    ...
    "N597": (
        "Adjusted based on a medical/dental provider's apportionment of care between related "
        "injuries and other unrelated medical/dental conditions/injuries."
    ),
    "N598": "Health care policy coverage is primary.",
    "N599": (
        "Our payment for this service is based upon a reasonable amount pursuant to both the terms "
        "and conditions of the policy of insurance under which the subject claim is being made as "
        "well as the Florida No-Fault Statute, which permits, when determining a reasonable charge "
        "for a service, an insurer to consider usual and customary charges and payments accepted by"
        " the provider, reimbursement levels in the community and various federal and state fee "
        "schedules applicable to automobile and other insurance coverages, and other information "
        "relevant to the reasonableness of the reimbursement for the service. The payment for this "
        "service is based upon 200% of the Participating Level of Medicare Part B fee schedule for "
        "the locale in which the services were rendered."
    ),
    "N600": (
        "Adjusted based on the applicable fee schedule for the region in which the service was "
        "rendered."
    ),
    "N601": (
        "In accordance with Hawaii Administrative Rules, Title 16, Chapter 23 Motor Vehicle "
        "Insurance Law payment is recommended based on Medicare Resource Based Relative Value Scale"
        " System applicable to Hawaii."
    ),
    "N602": "Adjusted based on the Redbook maximum allowance.",
    "N603": (
        "This fee is calculated according to the New Jersey medical fee schedules for Automobile "
        "Personal Injury Protection and Motor Bus Medical Expense Insurance Coverage."
    ),
    "N604": (
        "In accordance with New York No-Fault Law, Regulation 68, this base fee was calculated "
        "according to the New York Workers' Compensation Board Schedule of Medical Fees, pursuant "
        "to Regulation 83 and / or Appendix 17-C of 11 NYCRR."
    ),
    "N605": (
        "This fee was calculated based upon New York All Patients Refined Diagnosis Related Groups "
        "(APR-DRG), pursuant to Regulation 68."
    ),
    "N606": (
        "The Oregon allowed amount for this procedure is based upon the Workers Compensation Fee "
        "Schedule (OAR 436-009). The allowed amount has been calculated in accordance with Section "
        "4 of ORS 742.524."
    ),
    "N607": "Service provided for non-compensable condition(s).",
    "N608": (
        "The fee schedule amount allowed is calculated at 110% of the Medicare Fee Schedule for "
        "this region, specialty and type of service. This fee is calculated in compliance with Act "
        "6."
    ),
    "N609": (
    ...
    "N613": (
        "Alert: Although this was paid, you have billed with an ordering provider that needs to "
        "update their enrollment record. Please verify that the ordering provider information you "
        "submitted on the claim is accurate and if it is, contact the ordering provider instructing"
        " them to update their enrollment record. Unless corrected, a claim with this ordering "
        "provider will not be paid in the future."
    ),
    "N614": (
        "Alert: Additional information is included in the 835 Healthcare Policy Identification "
        "Segment (loop 2110 Service Payment Information)."
    ),
    "N615": (
        "Alert: This enrollee receiving advance payments of the premium tax credit is in the grace "
        "period of three consecutive months for non-payment of premium. Under 45 CFR 156.270, a "
        "Qualified Health Plan issuer must pay all appropriate claims for services rendered to the "
        "enrollee during the first month of the grace period and may pend claims for services "
        "rendered to the enrollee in the second and third months of the grace period."
    ),
    "N616": (
        "Alert: This enrollee is in the first month of the advance premium tax credit grace period."
    ),
    "N617": (
        "This enrollee is in the second or third month of the advance premium tax credit grace "
        "period."
    ),
    "N618": (
    ...
    "N628": (
        "Out-patient follow up visits on the same date of service as a scheduled test or treatment "
        "is disallowed."
    ),
    ...
    "N631": (
        "Medical Fee Schedule does not list this code. An allowance was made for a comparable "
        "service."
    ),
    "N632": (
        "According to the Official Medical Fee Schedule this service has a relative value of zero "
    ...
    "N639": (
        "Reimbursement has been made according to the inpatient rehabilitation facilities fee "
        "schedule."
    ),
    ...
    "N643": (
        "The services billed are considered Not Covered or Non-Covered (NC) in the applicable state"
        " fee schedule."
    ),
    ...
    "N651": (
        "No Personal Injury Protection/Medical Payments Coverage on the policy at the time of the "
        "loss."
    ),
    ...
    "N656": (
        "An interest payment is being made because benefits are being paid outside the statutory "
        "requirement."
    ),
    ...
    "N666": (
        "Only one evaluation and management code at this service level is covered during the course"
        " of care."
    ),
    ...
    "N670": (
        "This service code has been identified as the primary procedure code subject to the "
        "Medicare Multiple Procedure Payment Reduction (MPPR) rule."
    ),
    "N671": "Payment based on a jurisdiction cost-charge ratio.",
    "N672": "Alert: Amount applied to Health Insurance Offset.",
    "N673": (
        "Reimbursement has been calculated based on an outpatient per diem or an outpatient factor "
        "and/or fee schedule amount."
    ),
    ...
    "N695": (
        "Alert: This reversal is due to incorrect patient financial responsibility information on "
        "the initial adjudication."
    ),
    "N696": (
        "Alert: This reversal is due to a Coordination of Benefits or Third Party Liability "
        "Recovery retroactive adjustment."
    ),
    "N697": (
    ...
    "N698": (
        "Alert: This reversal is due to non-payment of the health insurance premiums (Health "
        "Insurance Exchange or other) by the end of the premium payment grace period, resulting in "
        "loss of coverage."
    ),
    "N699": (
    ...
    "N702": (
        "Decision based on review of previously adjudicated claims or for claims in process for the"
        " same/similar type of services."
    ),
    "N703": "This service is incompatible with previously adjudicated claims or claims in process.",
    "N704": (
        "Alert: You may not appeal this decision but can resubmit this claim/service with corrected"
    ...
    "N720": (
        "Alert: The patient overpaid you. You may need to issue the patient a refund for the "
        "difference between the patient's payment and the amount shown as patient responsibility on"
        " this notice."
    ),
    "N721": "This service is only covered when performed as part of a clinical trial.",
    "N722": (
        "Patient must use Workers' Compensation Set-Aside (WCSA) funds to pay for the medical "
        "service or item."
    ),
    "N723": (
    ...
    "N725": (
        "A liability insurer has reported having ongoing responsibility for medical services (ORM) "
        "for this diagnosis."
    ),
    "N726": "A conditional payment is not allowed.",
    "N727": (
        "A no-fault insurer has reported having ongoing responsibility for medical services (ORM) "
        "for this diagnosis."
    ),
    "N728": (
        "A workers' compensation insurer has reported having ongoing responsibility for medical "
    ...
    "N734": (
        "The patient is eligible for these medical services only when unable to work or perform "
        "normal activities due to an illness or injury."
    ),
    "N735": (
        "Adjustment without review of medical/dental record because the requested records were not "
    ...
    "N740": (
        "The member's Consumer Spending Account does not contain sufficient funds to cover the "
        "member's liability for this claim/service."
    ),
    "N741": "This is a site neutral payment.",
    "N742": (
        "Alert: This claim was processed based on one or more ICD-9 codes. The transition to ICD-10"
        " is required by October 1, 2015, for health care providers, health plans, and "
    ...
    "N747": (
        "This is a misdirected claim/service. Submit the claim to the payer/plan where the patient "
        "resides."
    ),
    ...
    "N754": (
        "Missing/incomplete/invalid Referring Provider or Other Source Qualifier on the 1500 Claim "
        "Form."
    ),
    ...
    "N759": (
        "Payment adjusted based on the National Electrical Manufacturers Association (NEMA) "
        "Standard XR-29-2013."
    ),
    ...
    "N767": (
        "The Medicaid state requires provider to be enrolled in the member's Medicaid state program"
        " prior to any claim benefits being processed."
    ),
    "N768": "Incomplete/invalid initial evaluation report.",
    "N769": "A lateral diagnosis is required.",
    "N770": (
        "The adjustment request received from the provider has been processed. Your original claim "
    ...
    "N774": (
        "Alert: Refer to your Third Party Processor Agreement for specific information on fees "
        "associated with this payment type."
    ),
    ...
    "N779": (
        "Replacement/Void claims cannot be submitted until the original claim has finalized. Please"
        " resubmit once payment or denial is received."
    ),
    "N780": "Missing/incomplete/invalid end therapy date.",
    "N781": (
        "Alert: Patient is a Medicaid/ Qualified Medicare Beneficiary. Review your records for any "
        "wrongfully collected deductible. This amount may be billed to a subsequent payer."
    ),
    "N782": (
        "Alert: Patient is a Medicaid/ Qualified Medicare Beneficiary. Review your records for any "
        "wrongfully collected coinsurance. This amount may be billed to a subsequent payer."
    ),
    "N783": (
        "Alert: Patient is a Medicaid/ Qualified Medicare Beneficiary. Review your records for any "
        "wrongfully collected copayment. This amount may be billed to a subsequent payer."
    ),
    ...
    "N787": (
        "Alert: Under 42 CFR 410.43, an eligible Partial Hospitalization Program (PHP) "
        "patient/beneficiary requires a minimum of 20 hours of PHP services per week, as evidenced "
        "in the plan of care. PHP services must be furnished in accordance with the plan of care."
    ),
    "N788": (
        "Alert: The third-party administrator/review organization did not receive the required "
        "information."
    ),
    ...
    "N793": (
        "Alert: Starting January 1, 2020, Medicare will ONLY accept claims submitted with the "
        "Medicare Beneficiary Identifier (MBI). Medicare will reject any claims submitted with the "
        "Health Insurance Claim Number (HICN) with a few exceptions. Please see "
        "www.cms.gov/Medicare/New-Medicare-Card/index.html for more information."
    ),
    ...
    "N801": (
        "Services performed in a Medicare participating or CAH facility under a self-insured tribal"
        " Group Health Plan, in accordance with Federal Regulation 42 CFR 136."
    ),
    "N802": (
        "This claim/service is not payable under our service area. The claim must be filed to the "
        "Payer/Plan in whose service area the Rendering Physician is located."
    ),
    "N803": (
        "Submission of the claim for the service rendered is the responsibility of the Contracted "
    ...
    "N809": (
        "Alert: The fee schedule amount for this service was adjusted based on prior competitive "
        "bidding rates. For more information, contact your local contractor."
    ),
    "N810": (
        "Alert: Due to federal, state or local disaster declaration, this claim has been processed "
        "at the in-network level of benefit. At the conclusion or expiration of the disaster "
        "declaration, network payment rules will be reinstated."
    ),
    ...
    "N817": (
        "Alert: Applicable laboratories are required to collect and report private payor data and "
        "report that data to CMS between January 1, 2020 - March 31, 2020."
    ),
    ...
    "N830": (
        "Alert: The charge[s] for this service was processed in accordance with Federal/ State, "
        "Balance Billing/ No Surprise Billing regulations. As such, any amount identified with OA, "
        "CO, or PI cannot be collected from the member and may be considered provider liability or "
        "be billable to a subsequent payer. Any amount the provider collected over the identified "
        "PR amount must be refunded to the patient within applicable Federal/State timeframes. "
        "Payment amounts are eligible for dispute pursuant to any Federal/State documented "
        "appeal/grievance process(es)."
    ),
    "N831": (
        "You have not responded to requests to revalidate your provider/supplier enrollment "
        "information."
    ),
    ...
    "N835": (
        "Unrelated Service/procedure/treatment is reduced. The balance of this charge is the "
    ...
    "N838": (
        ...
        "declaration. Any amounts applied to deductible or member liability will be applied to the "
        "prior plan year from which the procedure was cancelled."
    ),
    "N839": (
        "The procedure code was added/changed because the level of service exceeds the compensable "
        "condition(s)."
    ),
    ...
    "N844": (
        "This claim, or a portion of this claim, was processed in accordance with the Nebraska "
        "Legislative LB997 July 24, 2020 - Out of Network Emergency Medical Care Act."
    ),
    "N845": (
        "Alert: Nebraska Legislative LB997 July 24, 2020 - Out of Network Emergency Medical Care "
        "Act."
    ),
    ...
    "N854": (
        "Alert: If you have primary other health insurance (OHI) coverage that has denied services,"
        " you must exhaust all appeal levels with your primary OHI before we can consider your "
    ...
    "N856": (
        "This coverage is not subject to the exclusive jurisdiction of ERISA (1974), U.S.C. SEC "
        "1001."
    ),
    "N857": "This claim has been adjusted/reversed. Refund any collected copayment to the member.",
    "N858": (
        "Alert: State regulations relating to an Out of Network Medical Emergency Care Act were "
        "applied to the processing of this claim. Payment amounts are eligible for dispute "
        "following the state's documented appeal/ grievance/ arbitration process."
    ),
    "N859": (
        "Alert: The Federal No Surprise Billing Act was applied to the processing of this claim. "
        "Payment amounts are eligible for dispute pursuant to any Federal documented appeal/ "
        "grievance/ dispute resolution process(es)."
    ),
    "N860": (
        "Alert: The Federal No Surprise Billing Act Qualified Payment Amount (QPA) was used to "
        "calculate the member cost share(s)."
    ),
    "N861": (
        "Alert: Mismatch between the submitted Patient Liability/Share of Cost and the amount on "
        "record for this recipient."
    ),
    "N862": (
        "Alert: Member cost share is in compliance with the No Surprises Act, and is calculated "
        "using the lesser of the QPA or billed charge."
    ),
    "N863": (
        "Alert: This claim is subject to the No Surprises Act (NSA). The amount paid is the final "
        "out-of-network rate and was calculated based on an All Payer Model Agreement, in "
        "accordance with the NSA."
    ),
    "N864": (
        "Alert: This claim is subject to the No Surprises Act provisions that apply to emergency "
        "services."
    ),
    "N865": (
        "Alert: This claim is subject to the No Surprises Act provisions that apply to nonemergency"
        " services furnished by nonparticipating providers during a patient visit to a "
        "participating facility."
    ),
    "N866": (
        "Alert: This claim is subject to the No Surprises Act provisions that apply to services "
        "furnished by nonparticipating providers of air ambulance services."
    ),
    "N867": (
        "Alert: Cost sharing was calculated based on a specified state law, in accordance with the "
        "No Surprises Act."
    ),
    "N868": (
        "Alert: Cost sharing was calculated based on an All-Payer Model Agreement, in accordance "
        "with the No Surprises Act."
    ),
    "N869": (
        "Alert: Cost sharing was calculated based on the qualifying payment amount, in accordance "
        "with the No Surprises Act."
    ),
    "N870": (
        "Alert: In accordance with the No Surprises Act, cost sharing was based on the billed "
        "amount because the billed amount was lower than the qualifying payment amount."
    ),
    "N871": (
        "Alert: This initial payment was calculated based on a specified state law, in accordance "
        "with the No Surprises Act."
    ),
    "N872": (
        "Alert: This final payment was calculated based on a specified state law, in accordance "
        "with the No Surprises Act."
    ),
    "N873": (
        "Alert: This final payment was calculated based on an All-Payer Model Agreement, in "
        "accordance with the No Surprises Act."
    ),
    "N874": (
        "Alert: This final payment was determined through open negotiation, in accordance with the "
        "No Surprises Act."
    ),
    "N875": (
        "Alert: This final payment equals the amount selected as the out-of-network rate by a "
        "Federal Independent Dispute Resolution Entity, in accordance with the No Surprises Act."
    ),
    "N876": (
        "Alert: This item or service is covered under the plan. This is a notice of denial of "
        "payment provided in accordance with the No Surprises Act. The provider or facility may "
        "initiate open negotiation if they desire to negotiate a higher out-of-network rate than "
        "the amount paid by the patient in cost sharing."
    ),
    "N877": (
        "Alert: This initial payment is provided in accordance with the No Surprises Act. The "
        "provider or facility may initiate open negotiation if they desire to negotiate a higher "
        "out-of-network rate."
    ),
    "N878": (
        "Alert: The provider or facility specified that notice was provided and consent to balance "
        "bill obtained, but notice and consent was not provided and obtained in a manner consistent"
        " with applicable Federal law. Thus, cost sharing and the total amount paid have been "
        "calculated based on the requirements under the No Surprises Act, and balance billing is "
        "prohibited."
    ),
    "N879": (
        "Alert: The notice and consent to balance bill, and to be charged out-of-network cost "
        "sharing, that was obtained from the patient with regard to the billed services, is not "
        "permitted for these services. Thus, cost sharing and the total amount paid have been "
        "calculated based on the requirements under the No Surprises Act, and balance billing is "
        "prohibited."
    ),
    "N880": (
        "Original claim closed due to changes in submitted data. Adjustment claim will be processed"
        " under a new claim number."
    ),
    "N881": "Client Obligation, patient responsibility for Home & Community Based Services (HCBS)",
    "N882": (
        "Alert: The out-of-network payment and cost sharing amounts were based on the plan's "
        "allowance because the provider or facility obtained the patient's consent to waive the "
        "balance billing protections under the No Surprises Act."
    ),
    "N883": "Alert: Processed according to state law",
    "N884": (
        "Alert: The No Surprises Act may apply to this claim. Please contact payer for instructions"
        " on how to submit information regarding whether or not the item or service was furnished "
        "during a patient visit to a participating facility."
    ),
    "N885": (
        "Alert: This claim was not processed in accordance with the No Surprises Act cost-sharing "
        "or out-of-network payment requirements. The payer disagrees with your determination that "
        "those requirements apply. You may contact the payer to find out why it disagrees. You may "
        "appeal this adverse determination on behalf of the patient through the payer's internal "
    ...
    "N887": (
        "Providers not participating in the Medicare Advantage Plan have the right to appeal if the"
        " plan has partially or fully denied payment or if the provider believes the plan has not "
        "paid the services at the expected Medicare reimbursable rate or type of level/service. "
        "Providers may file their appeal in writing within 60 calendar days after the date of the "
        "remittance advice. For the plan to review the appeal, the plan will need a completed "
        "signed Waiver of Liability Statement. To obtain a Waiver of Liability form, please contact"
        " your Medicare Advantage Plan. Once we receive the completed forms, we will give you a "
        "decision on your appeal within 60 calendar days."
    ),
    "N888": "Alert: An electronic request for additional information has been sent for this claim.",
    "N889": (
        "Alert: This claim was originally processed in real-time, and we sent a real-time 835 "
        "response."
    ),
    "N890": "Electronic Visit Verification Data Element Requirements were not met.",
    "N891": (
        "The maximum allowable payment for this service/procedure was paid by the primary "
        "insurance. No further payment due."
    ),
    ...
    "N894": (
        "Alert: These payments are made subject to a reservation of rights for the Payor to recoup "
        "or otherwise recover all or part of these payments based on any of the following: outcome "
        "of pending or future litigation/ new or updated state, federal or regulatory guidance/ any"
        " other actions that may affect the Payor's obligation to make these payments."
    ),
    ...
    "N905": (
        "Our records show you have opted out of Medicare, agreeing with the patient not to bill "
        "Medicare for services/tests/supplies furnished. As result, we cannot pay this claim. The "
        "patient is not responsible for payment."
    ),
    "N906": "Service is not covered when patient is under age 45.",
    "N907": (
        "No refund because this claim has been identified as 340B-eligible with a ceiling price "
        "lower than the maximum fair price."
    ),
    "N908": (
        "No refund because this drug has been prospectively purchased at the maximum fair price."
    ),
    "N909": (
        "Refund amount has been calculated using a methodology that differs from the Standard "
        "Default Refund Amount calculation ((Wholesale Acquisition Cost minus Maximum Fair Price) "
        "times Quantity)."
    ),
    "N910": (
        "A refund cannot be provided for this claim at this time. Contact the manufacturer directly"
        " regarding your eligibility."
    ),
    "N911": (
        "This claim cannot be reimbursed by the manufacturer until the Part D plan submits "
        "corrected prescription drug event data to CMS for maximum fair price validation."
    ),
    "N912": "Our records indicate that this beneficiary did not elect hospice.",
    "N913": (
        "More than one Electronic Visit Verification record exists for the date and time of this "
        "service."
    ),
    "N914": (
        "This claim was priced and processed in accordance with California AB-72 Health care "
        "coverage."
    ),
    "N915": "Predetermination of services is not allowed under the member's plan.",
    "N916": (
        "The third party will render payment to the provider, and they will reimburse you for "
        "covered services."
    ),
    "N917": (
        "Alternative refund amount has been calculated because the maximum fair price is below the "
        "340B ceiling price."
    ),
    "N918": (
        "No refund because CMS excludes prescription drug event records when a compound code "
        "indicates it is for a compounded drug."
    ),
    "N919": "Family/member out-of-pocket maximum has been met.",
    "N920": (
        "Payment to the provider has been placed on hold as a result of active contract "
        "(re)negotiation."
    ),
    "N921": "The time limit for filing a reconsideration or appeal has expired.",
    "N922": "Missing primary care dentist information.",
    "N923": (
        "Not Denied - The Medicare Advantage Organization (MAO) made a payment responsibility "
        "determination."
    ),
    "N924": (
        "Pending (Not Denied) - The Medicare Advantage Organization (MAO) has not yet made a "
        "payment responsibility determination for the service at the time the encounter record was "
        "submitted."
    ),
    "N925": (
        "Denied - The Medicare Advantage Organization (MAO) determined that it had no payment "
        "responsibility for the service at the time the encounter record was submitted."
    ),
    "N926": (
        "Partially Denied - The Medicare Advantage Organization (MAO) determined that it had no "
        "payment responsibility for one or more service lines, but not all, at the time the "
        "encounter record was submitted."
    ),
    ...
    "N936": (
        "This service code has been identified as the secondary or tertiary procedure code subject "
        "to the Medicare Multiple Procedure Payment Reduction (MPPR) rule."
    ),
    "N937": "The service line denial threshold was exceeded.",
    "N938": "Alert: Do not resubmit. This claim will be automatically reprocessed.",
    "N939": "Alert: You may contact us for a peer-to-peer review.",
    "N940": "Missing/Incomplete/Invalid pre- and/or post-operative x-ray.",
}

DEACTIVATED_RARC: frozenset[str] = frozenset(
    {
        "M33",
        "M34",
        "M35",
