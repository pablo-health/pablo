...
def get_claim_receipt_repository() -> ClaimReceiptRepository:
    """Get the claim receipt (hop ledger) repository instance."""
...
def get_intake_document_repository() -> IntakeDocumentRepository:
    ...
    return PostgresIntakeDocumentRepository(_get_pg_session())


def get_intake_packet_repository() -> IntakePacketRepository:
    """Get intake packet repository instance."""
    from .postgres.intake_packet import PostgresIntakePacketRepository

    return PostgresIntakePacketRepository(_get_pg_session())
...
def get_patient_intake_assignment_repository() -> PatientIntakeAssignmentRepository:
    """Get intake assignment repository instance."""
    from .postgres.patient_intake_assignment import (
