...
class TestUpdateMedication:
    ...
    def test_update_discontinued_with_stop_reason(self, client_with_repo: TestClient) -> None:
    ...
    def test_create_stop_reason_defaults_to_none(self, client_with_repo: TestClient) -> None:
