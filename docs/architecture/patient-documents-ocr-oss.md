...
This unblocks the Kendra PMHNP pilot for patients whose prior-provider records
...
* Manual smoke against 2-3 real Kendra PDFs (or representative samples) —
...
* **Faxed-clinical-PDF quality.** Real-world scans vary wildly. Confidence
  threshold of 0.5 is a guess — calibrate against actual Kendra samples
  before launch.
