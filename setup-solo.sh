...
echo ""
echo "  2. If you see 'OAuth consent screen not configured':"
echo "     a. Click 'CONFIGURE CONSENT SCREEN'"
echo "     b. Choose 'External'"
echo "     c. Fill in App name: Pablo, your email for support + developer contact"
echo "     d. Click 'SAVE AND CONTINUE' through all steps"
echo ""
